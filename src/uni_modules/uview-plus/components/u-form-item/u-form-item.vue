	...
	<view class="u-form-item">
		...
		>
			...
			<slot name="label">
				...
				>
				<!-- style里面的width: addUnit(labelWidth || parentData.labelWidth), -->
					<!-- 为了块对齐 -->
			...
			<!-- 改到这里 -->
			<slot name="error">
				<text v-if="!!message && parentData.errorType === 'message'"
					class="u-form-item__body__right__message">{{ message }}</text>
			</slot>
