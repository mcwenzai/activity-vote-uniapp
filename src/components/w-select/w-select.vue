	...
	<view class="w-select" id="wSelect" :style="{
      ...
      '--select-bg-color': bgColor
		...
		<view :class="isShow ? 'select-wrap-active' : ''" class="select-wrap" @click="changeShow">
			...
			<scroll-view scroll-y v-show="optionsShow" :class="[isShow? showPosition === 'bottom'? 'animation-bottom-in': 'animation-top-in': showPosition === 'bottom'? 'animation-bottom-out': 'animation-top-out',
          showPosition === 'bottom'
            ? 'position-bottom'
            : 'position-top'
