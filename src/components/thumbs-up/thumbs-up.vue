	...
	export default {
		...
		props: {
			...
			showImgs: { // 显示图标路径
				...
				default: () => {
					return [
						'/static/like/thumbs-up1.png',
						'/static/like/thumbs-up2.png',
						'/static/like/thumbs-up3.png',
						'/static/like/thumbs-up4.png',
						'/static/like/thumbs-up5.png',
						'/static/like/thumbs-up6.png',
						'/static/like/thumbs-up7.png',
						'/static/like/thumbs-up8.png',
						'/static/like/thumbs-up9.png'
					]
				}
			},
			duration: { // 动画效果时间
